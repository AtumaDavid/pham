...
const AppointmentRecentActivities = () => {
  return (
      ...
      <div className="relative">
        <div className="w-[936px] h-[355px] flex-shrink-0 ">
          <div className="no_data_body">
            ...
            <p>
              Create a new appointment through the appointments manager dropdown <br />{" "}
              <span>Go to appointments manager Add new appointment.</span>{" "}
            </p>
          </div>
        </div>
...
export default AppointmentRecentActivities;
