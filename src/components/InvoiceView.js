...
const InvoiceView = ({ onClose }) => {
  return (
    <section className=" bg-black bg-opacity-25 w-[100%] h-[100%] font-euclid-circular-a fixed top-0 right-0 flex-col justify-start items-start">
      ...
      <div className=" font-euclid-circular-a bg-white w-[660px] h-[585px] fixed top-[11%] right-[20%] shadow flex-col justify-start items-start p-2 overflow-auto">
        <img src={Invoice} alt="Invoice view" />
      </div>
    </section>
  );
};
