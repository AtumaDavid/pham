...
const DocumentView = ({onClose}) => {
  return (
    ...
    <div className=" font-euclid-circular-a bg-white w-[740px] h-[585px] fixed top-[8%] right-[18%] shadow flex-col justify-start items-start p-4 overflow-auto">
      <img src={Xray} alt="bone xray" />
    </div>
  </section>
  )
}
